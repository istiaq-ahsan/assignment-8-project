...
const Navbar = () => {
    return (
        <div className="mx-auto navbar backdrop-blur-xl bg-white/30 z-50 fixed">
            <div className="container mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            ...
                            <NavLink className={(
                                { isActive }) => `font-bold ${isActive ? 'text-warning' : 'hover:text-warning'}`}
                                to="/">Home</NavLink>
                            <NavLink className={(
                                { isActive }) => `font-bold ${isActive ? 'text-warning' : 'hover:text-warning'}`}
                ...
                <div className="navbar-end text-right gap-3 space-x-2">
